  ...
  const upcoming = [
    {
      ...
      desc:"Every choice triggers a live AI generation — the story continues forever, adapting to your exact playstyle so No two playthroughs are ever the same.",
      eta:"planned",
    },
    {
    ...
    },
    {
      ...
      desc:"every scene gets an AI generated illustration that changes with the story",
      eta:"planned",
    },
  ];
